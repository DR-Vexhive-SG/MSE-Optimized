...
# Crear DB explícitamente y pasarla al bot
pattern_db = MarketPatternDatabase()
initial_count = len(pattern_db.patterns)
initial_crist = sum(1 for p in pattern_db.patterns.values() if p.get('crystallized'))
