...
if os.path.exists(db_path): os.remove(db_path); print(f"🧹 DB eliminada")

bot = TradingBotAutonomous(use_ai=True, use_patterns=True)
...
new_bot = TradingBotAutonomous(use_ai=True, use_patterns=True)
